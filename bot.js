   ...
   .then(function (res) { 
     ...
     else
     {
       if (res.data["confirmations"] === 1 && res.data["product"]["confirmations"]) {
         ...
         message.reply("_G.Key = '"+key+"'\nloadstring(game:HttpGet('https://botjsrobloxwhitelist.herokuapp.com/script.lua', true))()") // Change PROJECTNAME to the project u made on heroku!!!
...
client.login("MTAwODY3MzkzMTg5ODY2MjkxMg.GNlt0H.osR9ufySOaHkjIDKK5tKiowdmlExswLCP2PiI4")
